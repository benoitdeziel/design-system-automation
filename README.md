...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/stlSJQSWfT)
...
```sh
npx nx serve crispy-bacon
```

To create a production bundle:

```sh
npx nx build crispy-bacon
```

To see all available targets to run for a project, run:

```sh
npx nx show project crispy-bacon
```
